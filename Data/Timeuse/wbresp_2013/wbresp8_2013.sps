...
WETYPICA "Edited: Thinking about yesterday as a whole, how would you say your feelings, both good and bad, compared to a typical [FILLDAY]? Were they better than a typical [FILL=DAY], the same as a typical [FILL=DAY], or worse than a typical [FILL=DAY]?" /
WRTELIG "Total time spent in all activities eligible to be selected for Well-being module" /
WUFINLWT "Well-being module respondent weight" /
WXCANTRI "WECANTRI: allocation flag" /
...
WXTYPICA "WETYPICA: allocation flag" /
.
VALUE LABELS
WEGENHTH
-1 "Blank"
